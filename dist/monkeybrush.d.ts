...
declare namespace MB {
    namespace maths {
        ...
        class Vect4 {
            ...
            w: number;
            /**
             * Returns whether or not current Vect4 and another Vect4 have exactly the same elements in the same position
             * @param  {Vect4}   other The second vector
             * @return {boolean} True if the vectors are equals, false otherwise
             */
            exactEquals(other: Vect4): boolean;
            /**
             * Returns whether or not current Vect4 and another Vect4 have approximately the same elements in the same position.
             * @param  {Vect4}   other The second vector
             * @param  {boolean} Enable or disable threshold epsilon in values comparison
             * @return {boolean} True if the vectors are equals, false otherwise
             */
...
declare namespace MB {
    class Camera2 {
        ...
        timeElapsed: number;
        GetPos(): MB.maths.Vect3;
        setHome(v: MB.maths.Vect3): void;
        constructor(position?: MB.maths.Vect3, up?: MB.maths.Vect3, yaw?: number, pitch?: number);
        ...
        GetViewMatrix(): MB.maths.Mat4;
        GetOrthoProjectionMatrix(w: number, h: number): MB.maths.Mat4;
        GetProjectionMatrix(w: number, h: number): MB.maths.Mat4;
        fov: number;
    }
}
...
declare namespace MB {
    abstract class Scene {
        ...
        webglVersion(): number;
        abstract loadAssets(): any;
        abstract initialize(): any;
        abstract update(dt: number): any;
        abstract draw(dt?: number): any;
        abstract cameraUpdate(): any;
        abstract textCB(g: dat.GUI): any;
...
declare namespace MB {
    namespace models {
        ...
        abstract class Drawable {
             ...
             */
            protected addElementArray(data: Uint16Array, type?: MB.ctes.UsageType): core.VertexBuffer;
            /**
             ...
             */
            protected addBufferArray(attribLocation: number, data: Float32Array, numElems: number, type?: MB.ctes.UsageType): MB.core.VertexBuffer;
            /**
             * Normal render
             */
            render(): void;
...
declare namespace MB {
    namespace core {
        ...
        class Framebuffer {
            ...
            _renderBuffer: MB.textures.RenderBufferTexture;
            _depth: MB.textures.SimpleTexture2D;
            protected _valid: boolean;
            constructor(textures: Array<MB.textures.Texture>, size: MB.maths.Vect2, depth?: boolean, stencil?: boolean, options?: {});
            /**
             ...
             */
            replaceTexture(tex: MB.textures.Texture, attach: number): void;
            /**
             ...
             */
            rebuild(size: MB.maths.Vect2): void;
            /**
...
declare namespace MB {
    namespace core {
        ...
        class GlobalState {
            ...
            static _bgColor: MB.extras.Color4;
            static _currentColorMask: MB.maths.Vector4<boolean>;
            static _currentColorClear: MB.extras.Color4;
            static setMask(colorMask: MB.maths.Vector4<boolean>): void;
            /**
            ...
            static _scissorsBox: MB.maths.Box2D;
             ...
             * @param {number} height: Specifying the height of the scissor box.
             */
            static setScissorsRectangleBox2D(b: MB.maths.Box2D): void;
            /**
             * Get scissor rectangle in use.
             * @return {MB.maths.Box2D}: Scissor box size
             */
            static getScissorsRectangle(): MB.maths.Box2D;
            /**
...
declare namespace MB {
    namespace core {
        ...
        class Program {
             ...
             */
            addShader(shader_: string, type: MB.ctes.ProgramCte.shader_type, _mode: MB.ctes.ProgramCte.mode): void;
            /**
             ...
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Vect2} value Vector of floats.
             */
            sendUniformVec2(name: string, value: Float32Array | MB.maths.Vect2): void;
            /**
             * Send uniform vector of float with 3 values.
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Vect3} value Vector of floats.
             */
            sendUniformVec3(name: string, value: Float32Array | MB.maths.Vect3): void;
            /**
             * Send uniform vector of float with 4 values.
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Vect4} value Vector of floats.
             */
            sendUniformVec4(name: string, value: Float32Array | MB.maths.Vect4): void;
            /**
             * Send uniform mat2.
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Mat2} value mat2.
             * @param {boolean = false} transpose Transpose mat2.
             */
            sendUniformMat2(name: string, value: Float32Array | MB.maths.Mat2, transpose?: boolean): void;
            /**
             * Send uniform mat3.
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Mat3} value mat3.
             * @param {boolean = false} transpose Transpose mat3.
             */
            sendUniformMat3(name: string, value: Float32Array | MB.maths.Mat3, transpose?: boolean): void;
            /**
             * Send uniform mat4.
             * @param {string} name  Uniform name.
             * @param {Float32Array | MB.maths.Mat4} value mat4.
             * @param {boolean = false} transpose Transpose mat4.
             */
            sendUniformMat4(name: string, value: Float32Array | MB.maths.Mat4, transpose?: boolean): void;
...
declare namespace MB {
    namespace extras {
        class Axis extends MB.models.Drawable {
            indices: number[];
            colors: number[];
...
declare namespace MB {
    namespace extras {
        ...
        class Billboard {
            static mesh: MB.models.CustomModel;
            static program: MB.core.Program;
            static initialize(): void;
            static bind(): void;
...
declare namespace MB {
    namespace extras {
        ...
        class Color3 {
             ...
             */
            protected _color: MB.maths.Vect3;
            /**
             * Color3 constructor
...
declare namespace MB {
    namespace extras {
        ...
        class PingPong {
             ...
             */
            resize(size: MB.maths.Vect2): void;
        }
    }
}
...
declare namespace MB {
    namespace extras {
        ...
        class PointCloud {
            ...
            protected _vb: MB.core.VertexBuffer;
            constructor();
            protected addBufferArray(attribLocation: number, data: Float32Array, numElems: number, type?: MB.ctes.UsageType): MB.core.VertexBuffer;
            addPoint(point: MB.maths.Vect3): void;
            render(): void;
        }
    }
}
    ...
    namespace extras {
        ...
        */
        class PostProcess {
             ...
             * @type {VertexArray}
             */
            protected static _planeVAO: MB.core.VertexArray;
            /**
             * [_planeVertexVBO description]
             * @type {VertexBuffer}
             */
            protected static _planeVertexVBO: MB.core.VertexBuffer;
        }
    }
}
...
declare namespace MB {
    namespace extras {
        ...
        class Ray {
             ...
             */
            constructor(origin?: MB.maths.Vect3, direction?: MB.maths.Vect3);
            /**
...
declare namespace MB {
    namespace extras {
        ...
        class Skybox {
             ...
             */
            texture: MB.textures.CubeMapTexture;
            /**
             * Skybox constructor
             ...
             */
            render(view: MB.maths.Mat4, projection: MB.maths.Mat4): void;
            /**
             * Destroy skybox.
             */
            destroy(): void;
...
declare namespace MB {
    namespace extras {
        ...
        class Sprite {
            ...
            constructor();
            setPosition(pos: MB.maths.Vect3): void;
        }
    }
}
...
declare namespace MB {
    namespace extras {
        ...
        class VertexBufferGeometry {
             ...
             */
            computingBoundingBox(): MB.maths.Box3D;
        }
    }
}
...
declare namespace MB {
    namespace lights {
        ...
        abstract class Light {
             ...
             * @param {MB.extras.Color3} color Color value
             */
            specularColor: MB.extras.Color3;
        }
    }
}
...
declare namespace MB {
    namespace lights {
        ...
        class DirectionalLight extends Light {
             ...
             */
            constructor(direction?: MB.maths.Vect3);
            /**
...
declare namespace MB {
    namespace lights {
        ...
        class PointLight extends Light {
             ...
             */
            constructor(position?: MB.maths.Vect3);
            /**
...
declare namespace MB {
    namespace lights {
        ...
        class SpotLight extends Light {
             ...
             */
            constructor(position?: MB.maths.Vect3, direction?: MB.maths.Vect3, cuttoff?: number);
            /**
...
declare namespace MB {
    namespace models {
        ...
        class Lathe extends Drawable {
             ...
             */
            constructor(points: ArrayLike<MB.maths.Vect3>, segments: number, phiInit?: number, phiRadius?: number);
        }
    }
}
...
declare namespace MB {
    namespace models {
        ...
        class ParametricGeom extends Drawable {
            /**
             * ParametricGeom
             * @param {number) => MB.maths.Vect3} func Function generator (u, v) => MB.maths.Vect3
             * @param {number} slices Number of slices
             * @param {number} stacks Number of stacks
             */
            constructor(func: (u: number, v: number) => MB.maths.Vect3, slices: number, stacks: number);
        }
    }
}
...
declare namespace MB {
    namespace resources {
        ...
        class ProgramManager {
             ...
             */
            static get(name: string): MB.core.Program;
            /**
             ...
             */
            static add(name: string, prog: MB.core.Program): void;
            /**
...
declare namespace MB {
    namespace textures {
        class RenderBufferMultisampleTexture {
            ...
            constructor(size: MB.maths.Vect2, format: number, attachment: number, samples?: number);
            bind(): void;
            unbind(): void;
            destroy(): void;
            resize(size: MB.maths.Vect2): void;
...
declare namespace MB {
    namespace textures {
        class SimpleTexture2D extends Texture {
             ...
             */
            constructor(size: MB.maths.Vect2, options?: TexOptions, onSuccess?: () => void);
            setInmutable(size?: MB.maths.Vect2): void;
            resize(size: MB.maths.Vect2): void;
        }
    }
}
...
declare namespace MB {
    namespace textures {
        class SimpleTexture3D extends Texture {
             ...
             */
            constructor(data: any, size: MB.maths.Vect3, options?: TexOptions, onSuccess?: () => void);
        }
    }
}
