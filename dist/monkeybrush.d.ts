...
declare namespace MB {
    ...
    class Program {
         ...
         */
        feedbackVarying(context: GLContext, varyings: Array<string>, mode: MB.ctes.TFMode): void;
        /**
...
declare namespace MB {
    ...
    abstract class Texture {
        ...
        static canUseFloatingPointLinearFiltering(context: GLContext): boolean;
        /**
...
declare namespace MB {
    class SimpleTexture3D extends Texture {
         ...
         */
        constructor(context: GLContext, data: any, size: MB.Vect3, options?: TexOptions, onSuccess?: () => void);
    }
}
...
declare namespace MB {
    class Texture2D extends Texture {
         ...
         */
        constructor(context: GLContext, data: any, options?: TexOptions, onSuccess?: () => void);
    }
}
...
declare namespace MB {
    class Texture2DArray extends Texture {
         ...
         */
        constructor(context: GLContext, size: Vector2<number>, images: Array<any>, options?: TexOptions, onSuccess?: () => void);
        layer: number;
        incLayer(): void;
    }
}
...
declare namespace MBX {
    ...
    class VideoTexture extends MB.Texture {
         ...
         */
        constructor(context: MB.GLContext, video: HTMLVideoElement, loop?: boolean, frameTime?: number, onSuccess?: () => void);
        update(): void;
        destroy(): void;
    }
}
